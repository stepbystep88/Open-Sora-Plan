...
def run_model_and_save_images(videogen_pipeline, transformer_model, video_length, image_size, model_path):
    ...
    for index, (prompt, latent_) in enumerate(first_frame_latent.items()):
        ...
        videos = videogen_pipeline(prompt,
                                   ...
                                   mask_feature=True,
                                   first_frame_latent=latent_.to(device),
                                   ).video
        print(videos.shape)
        try:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        import pickle
        with open('/home/image_data/yancen/first_frame_latent.pkl', 'rb') as f:
            first_frame_latent = pickle.load(f)
